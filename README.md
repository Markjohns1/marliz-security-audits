...
├── Methodology/
│   └── Field-Manual/ (Offensive Techniques)
└── Pro-SOC-Operations/ (Defensive Mastery & SIEM)
```
...
*   **Outcome:** Attacker exfiltrated sensitive files before being detected. Full containment achieved within 10 minutes. Zero persistence established.
*   **Key Metrics:**
...
### 2. Windows 10 Remote Keylogger Forensics (DFIR)
*   **Target:** Legacy Win10 Workstation
*   **Date:** February 8, 2026
*   **Severity:** High
*   **Outcome:** Post-mortem analysis identified persistence via Registry Run keys. Successfully mapped the exfiltration IP to a known malicious botnet.
*   [Read Full Report](./DFIR/2026-02-08_windows-keylogger-forensics/INCIDENT_REPORT.md)

### 3. Playkart E-Commerce Security Audit (Penetration Test)
*   **Target:** playkartstores.com (External Client)
*   **Date:** February 4, 2026
*   **Severity:** Critical
*   **Outcome:** Identified RCE backdoors, plain-text credential leakage, and broken access controls. Full "Domain Healing" recommended.
...
For security consultations or to report a vulnerability:
*   **Website:** [marlizintel.com](https://marlizintel.com)
*   **Lead Analyst:** Mark J.

---

**Disclaimer:** All audits are performed ethically and with proper authorization. External client engagements are conducted under responsible disclosure agreements.
